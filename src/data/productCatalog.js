...
export const PRODUCT_CATALOG = [
    ...
    },
    {
        ...
        products: [
            ...
            { id: 'hk-1gs-white-gushers', name: '1.1G Sweet - White Gushers', description: 'Sweet Edition | Hybrid', price: 20.50, caseSize: 10, unit: 'unit', thc: 'Coming Soon', strainType: 'Hybrid', category: 'Vape', inStock: false },
            { id: 'hk-1gs-mango-kush', name: '1.1G Sweet - Mango Kush', description: 'Sweet Edition | Hybrid', price: 20.50, caseSize: 10, unit: 'unit', thc: 'Coming Soon', strainType: 'Hybrid', category: 'Vape', inStock: false },
            ...
            { id: 'hk-1gs-wedding-cake', name: '1.1G Sweet - Wedding Cake', description: 'Sweet Edition | Indica', price: 20.50, caseSize: 10, unit: 'unit', thc: 'Coming Soon', strainType: 'Indica', category: 'Vape', inStock: false },
            { id: 'hk-1gs-purple-drink', name: '1.1G Sweet - Purple Drink', description: 'Sweet Edition | Indica', price: 20.50, caseSize: 10, unit: 'unit', thc: 'Coming Soon', strainType: 'Indica', category: 'Vape', inStock: false },
            ...
            // 7x 0.5G Live Resin ROYAL MINIS ($22.50 / unit, 16ct pack)
            { id: 'hk-mini-og-blend', name: 'Live Resin Minis - OG Blend', description: '7x 0.5G | Hybrid', price: 22.50, caseSize: 16, unit: 'unit', thc: '35.26%', strainType: 'Hybrid', category: 'Pre-Roll', inStock: true },
            { id: 'hk-mini-papaya-melon', name: 'Live Resin Minis - Papaya Melon', description: '7x 0.5G | Hybrid', price: 22.50, caseSize: 16, unit: 'unit', thc: '37.63%', strainType: 'Hybrid', category: 'Pre-Roll', inStock: true },
            { id: 'hk-mini-blueberry', name: 'Live Resin Minis - Blueberry', description: '7x 0.5G | Indica', price: 22.50, caseSize: 16, unit: 'unit', thc: '35.75%', strainType: 'Indica', category: 'Pre-Roll', inStock: true },
            { id: 'hk-mini-gmo', name: 'Live Resin Minis - GMO', description: '7x 0.5G | Indica', price: 22.50, caseSize: 16, unit: 'unit', thc: '31.26%', strainType: 'Indica', category: 'Pre-Roll', inStock: true },
            { id: 'hk-mini-grape-dosi', name: 'Live Resin Minis - Grape Dosi', description: '7x 0.5G | Sativa', price: 22.50, caseSize: 16, unit: 'unit', thc: '36.17%', strainType: 'Sativa', category: 'Pre-Roll', inStock: true },
            { id: 'hk-mini-sativa-blend', name: 'Live Resin Minis - Sativa Blend', description: '7x 0.5G | Sativa', price: 22.50, caseSize: 16, unit: 'unit', thc: '37.80%', strainType: 'Sativa', category: 'Pre-Roll', inStock: true },

            // 1.5G KIEF-COATED DIAMOND INFUSED PRE-ROLL ($8.60 / unit, 24ct pack)
            { id: 'hk-pre-cotton-candy', name: 'Infused Pre-Roll - Cotton Candy', description: '1.5G Kief-Coated | Hybrid', price: 8.60, caseSize: 24, unit: 'unit', thc: '33.63%', strainType: 'Hybrid', category: 'Pre-Roll', inStock: true },
            { id: 'hk-pre-gorilla-glue', name: 'Infused Pre-Roll - Gorilla Glue', description: '1.5G Kief-Coated | Hybrid', price: 8.60, caseSize: 24, unit: 'unit', thc: '33.59%', strainType: 'Hybrid', category: 'Pre-Roll', inStock: true },
            { id: 'hk-pre-mango-kush', name: 'Infused Pre-Roll - Mango Kush', description: '1.5G Kief-Coated | Hybrid', price: 8.60, caseSize: 24, unit: 'unit', thc: '32.47%', strainType: 'Hybrid', category: 'Pre-Roll', inStock: true },
            { id: 'hk-pre-white-runts', name: 'Infused Pre-Roll - White Runts', description: '1.5G Kief-Coated | Hybrid', price: 8.60, caseSize: 24, unit: 'unit', thc: '35.61%', strainType: 'Hybrid', category: 'Pre-Roll', inStock: true },
            { id: 'hk-pre-blueberry', name: 'Infused Pre-Roll - Blueberry', description: '1.5G Kief-Coated | Indica', price: 8.60, caseSize: 24, unit: 'unit', thc: 'Out of Stock', strainType: 'Indica', category: 'Pre-Roll', inStock: false },
            { id: 'hk-pre-skywalker-og', name: 'Infused Pre-Roll - Skywalker OG', description: '1.5G Kief-Coated | Indica', price: 8.60, caseSize: 24, unit: 'unit', thc: 'Out of Stock', strainType: 'Indica', category: 'Pre-Roll', inStock: false },
            { id: 'hk-pre-emergency', name: 'Infused Pre-Roll - Emergency', description: '1.5G Kief-Coated | Sativa', price: 8.60, caseSize: 24, unit: 'unit', thc: '31.23%', strainType: 'Sativa', category: 'Pre-Roll', inStock: true },
            { id: 'hk-pre-green-crack', name: 'Infused Pre-Roll - Green Crack', description: '1.5G Kief-Coated | Sativa', price: 8.60, caseSize: 24, unit: 'unit', thc: '46.56%', strainType: 'Sativa', category: 'Pre-Roll', inStock: true },
            { id: 'hk-pre-maui-waui', name: 'Infused Pre-Roll - Maui Waui', description: '1.5G Kief-Coated | Sativa', price: 8.60, caseSize: 24, unit: 'unit', thc: '35.38%', strainType: 'Sativa', category: 'Pre-Roll', inStock: true },
            ...
            { id: 'hk-dia-rainbow-belt', name: 'Diamond Pre-Roll - Rainbow Belt', description: '1.5G Infused | Hybrid', price: 6.44, caseSize: 12, unit: 'unit', thc: '42.78%', strainType: 'Hybrid', category: 'Pre-Roll', inStock: true },
            { id: 'hk-dia-strawberry-diesel', name: 'Diamond Pre-Roll - Strawberry Diesel', description: '1.5G Infused | Sativa', price: 6.44, caseSize: 12, unit: 'unit', thc: '35.44%', strainType: 'Sativa', category: 'Pre-Roll', inStock: true }
        ]
    },
    {
        id: 'bud-cracker',
    ...
    },
    {
        ...
        products: [
            ...
            { id: 'wz-diamond-oc', name: 'Concentrates - Decarbed Diamonds - Orange Cake (1G)', description: 'Coming Soon', price: 22.50, caseSize: 20, unit: 'unit', thc: '80%', strainType: 'Sativa', category: 'Concentrate', inStock: true },
            { id: 'wz-diamond-lcf', name: 'Concentrates - Decarbed Diamonds - Lemon Cherry Fritter (1G)', description: 'Coming Soon', price: 22.50, caseSize: 20, unit: 'unit', thc: '81%', strainType: 'Hybrid', category: 'Concentrate', inStock: true },
            { id: 'wz-raw-fk', name: 'Concentrates - Diamonds - Fruit King (1G)', description: 'Coming Soon', price: 22.50, caseSize: 20, unit: 'unit', thc: '82%', strainType: 'Indica', category: 'Concentrate', inStock: true },
            { id: 'wz-raw-lcf', name: 'Concentrates - Diamonds - Lemon Cherry Fritter (1G)', description: 'Coming Soon', price: 22.50, caseSize: 20, unit: 'unit', thc: '83%', strainType: 'Hybrid', category: 'Concentrate', inStock: true },
