...
export const PRODUCT_CATALOG = [
    {
        ...
        products: [
            ...
            { id: 'hk-pre-blueberry', name: 'Infused Pre-Roll - Blueberry', description: '1.5G Kief-Coated | Indica', price: 8.60, caseSize: 24, unit: 'unit', thc: '', strainType: 'Indica', category: 'Pre-Roll', inStock: true },
            { id: 'hk-pre-skywalker-og', name: 'Infused Pre-Roll - Skywalker OG', description: '1.5G Kief-Coated | Indica', price: 8.60, caseSize: 24, unit: 'unit', thc: '', strainType: 'Indica', category: 'Pre-Roll', inStock: true },
