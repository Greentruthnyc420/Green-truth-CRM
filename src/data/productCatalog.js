...
export const PRODUCT_CATALOG = [
    {
        ...
        products: [
            ...
            { id: 'hk-1gs-white-gushers', name: '1.1G Sweet - White Gushers', description: 'Sweet Edition | Hybrid', price: 20.50, caseSize: 10, unit: 'unit', thc: null, strainType: 'Hybrid', category: 'Vape', inStock: true },
            { id: 'hk-1gs-mango-kush', name: '1.1G Sweet - Mango Kush', description: 'Sweet Edition | Hybrid', price: 20.50, caseSize: 10, unit: 'unit', thc: null, strainType: 'Hybrid', category: 'Vape', inStock: true },
            ...
            { id: 'hk-1gs-wedding-cake', name: '1.1G Sweet - Wedding Cake', description: 'Sweet Edition | Indica', price: 20.50, caseSize: 10, unit: 'unit', thc: null, strainType: 'Indica', category: 'Vape', inStock: true },
            { id: 'hk-1gs-purple-drink', name: '1.1G Sweet - Purple Drink', description: 'Sweet Edition | Indica', price: 20.50, caseSize: 10, unit: 'unit', thc: null, strainType: 'Indica', category: 'Vape', inStock: true },
            ...
            { id: 'hk-pre-blueberry', name: 'Infused Pre-Roll - Blueberry', description: '1.5G Kief-Coated | Indica', price: 8.60, caseSize: 24, unit: 'unit', thc: null, strainType: 'Indica', category: 'Pre-Roll', inStock: true },
            { id: 'hk-pre-skywalker-og', name: 'Infused Pre-Roll - Skywalker OG', description: '1.5G Kief-Coated | Indica', price: 8.60, caseSize: 24, unit: 'unit', thc: null, strainType: 'Indica', category: 'Pre-Roll', inStock: true },
