            ...
            <div className="themed-card w-full max-w-md rounded-2xl overflow-hidden">
                ...
                <div className="bg-slate-900 p-6 md:p-8 text-center relative overflow-hidden">
                    ...
                    <div className="relative z-10">
                        {/* Responsive logo - LARGE centered */}
                        <div className="w-full max-w-lg h-48 md:h-64 mx-auto flex items-center justify-center mb-4 md:mb-6 transition-transform hover:scale-105 duration-300">
