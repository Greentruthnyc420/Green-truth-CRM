...
export default function BrandOrderUploadModal({ isOpen, onClose, brandId, onOrderCreated }) {
    ...
    return (
        <div className="fixed inset-0 bg-black/50 z-50 flex items-center justify-center p-4" role="dialog" aria-modal="true" aria-labelledby="brand-order-upload-modal-title">
            <div className="rounded-2xl w-full max-w-2xl shadow-xl animate-in fade-in zoom-in duration-200" style={{ background: 'var(--bg-card)' }}>
                <div className="p-6 border-b border-slate-100 flex justify-between items-center">
                    <h2 id="brand-order-upload-modal-title" className="text-xl font-bold text-slate-800 flex items-center gap-2">
                        <FileSpreadsheet className="text-emerald-600" />
                        Import Orders from CSV
                    </h2>
                    <button onClick={handleClose} className="p-2 hover:bg-slate-100 rounded-full transition-colors" aria-label="Close modal">
