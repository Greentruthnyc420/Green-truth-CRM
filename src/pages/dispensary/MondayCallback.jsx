...
export default function MondayCallback() {
        ...
        const handleCallback = async () => {
            ...
            try {
                ...
                await exchangeMondayToken({
                    code,
                    redirectUri: window.location.origin + '/dispensary/integrations/monday/callback',
                    brandId: null, // Not needed for dispensary
                    userType: 'dispensary'
                });
                ...
                if (msg.includes('redirect_uri_mismatch')) {
                    msg = 'Redirect URI mismatch. Please ensure your Monday App settings match: ' + window.location.origin + '/dispensary/integrations/monday/callback';
                }
    ...
    }, [searchParams, currentUser, navigate, functions]);
    ...
    return (
        <div className="flex flex-col items-center justify-center min-h-screen bg-slate-50">
            ...
            <p className="text-slate-500 text-sm">Please wait while we set up your Dispensary boards.</p>
        </div>
    );
}
