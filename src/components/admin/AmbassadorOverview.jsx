...
export default function AmbassadorOverview({ currentUserOverride, showHourlyRate = true }) {
    ...
    return (
        <div className="space-y-6">
            ...
            <div className="mb-6">
                <h1 className="text-2xl font-bold text-slate-800">My Stats & Earnings</h1>
                <p className="text-slate-500">Here's your personal compensation breakdown.</p>
                {milestoneMessage && (
